...
#Lesa skrá -fá nafn frá notanda(input)
#opna skra og lesa
#Gera dictionary af players: 
    #Key -> chess player
    #Values -> hin gögnin
#Búa til dictionary af countries:
    #key -> country name
    #Value -> list of chess players
#Prenta út upplýsingar eftir löndum í réttu formatti
